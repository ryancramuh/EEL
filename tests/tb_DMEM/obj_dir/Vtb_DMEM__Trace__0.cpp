...
void Vtb_DMEM___024root__trace_chg_0_sub_0(Vtb_DMEM___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        ...
        bufp->chgSData(oldp+7,((0x3fffU & ((IData)(vlSelfRef.tb_DMEM__DOT__ADDR) 
                                           - (IData)(0x2000U)))),14);
    }
    bufp->chgBit(oldp+8,(vlSelfRef.tb_DMEM__DOT__CLK));
    bufp->chgIData(oldp+9,(vlSelfRef.tb_DMEM__DOT__UUT__DOT__DATA_OUT),32);
    bufp->chgIData(oldp+10,(((0U == (IData)(vlSelfRef.tb_DMEM__DOT__BYTE_SEL))
                              ? ((IData)(vlSelfRef.tb_DMEM__DOT__SIGN)
                                  ? (0xffffff00U | 
