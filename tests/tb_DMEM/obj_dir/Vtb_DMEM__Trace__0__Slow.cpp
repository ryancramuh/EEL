...
VL_ATTR_COLD void Vtb_DMEM___024root__trace_init_sub__TOP__0(Vtb_DMEM___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+12,0,"ADDR_DEPTH",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+13,0,"DATA_MEM_BASE",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 13,0);
    ...
    tracep->declBus(c+11,0,"data_out",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+8,0,"actual_addr",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 13,0);
    tracep->popPrefix();
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vtb_DMEM___024root__trace_const_0_sub_0(Vtb_DMEM___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullIData(oldp+12,(0xeU),32);
    bufp->fullSData(oldp+13,(0x2000U),14);
...
VL_ATTR_COLD void Vtb_DMEM___024root__trace_full_0_sub_0(Vtb_DMEM___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullSData(oldp+8,((0x3fffU & ((IData)(vlSelfRef.tb_DMEM__DOT__ADDR) 
                                        - (IData)(0x2000U)))),14);
    bufp->fullBit(oldp+9,(vlSelfRef.tb_DMEM__DOT__CLK));
    bufp->fullIData(oldp+10,(vlSelfRef.tb_DMEM__DOT__UUT__DOT__DATA_OUT),32);
    bufp->fullIData(oldp+11,(((0U == (IData)(vlSelfRef.tb_DMEM__DOT__BYTE_SEL))
                               ? ((IData)(vlSelfRef.tb_DMEM__DOT__SIGN)
                                   ? (0xffffff00U | 
