...
void Vtb_IMEM::eval_end_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+eval_end_step Vtb_IMEM::eval_end_step\n"); );
#ifdef VM_TRACE
    // Tracing
...
//============================================================
// Events and timing
bool Vtb_IMEM::eventsPending() { return !vlSymsp->TOP.__VdlySched.empty(); }
